...
if (!class_exists('ThemeToolkit')) {
	class ThemeToolkit{
		...
		function admin_menu () {
			...
			echo '<div class="wrap"><h2>Theme Options</h2>';
			echo '<p>Thank you for installing ' . $this->infos['theme_site'] . ', a theme for Wordpress. This theme was made by '.$this->infos['theme_author'].'. Default settings for the theme have automatically been loaded. Please take a moment to carefully read through the options below. And enjoy.</p>';
