...
*/
	...
	function podPress_getID3tags($mediafile, $resolved = false) {
        GLOBAL $podPress;
        ...
        if(file_exists($systemFileName)) {
            ...
            $buffer = podPress_downloadFile($uriFileName);
	...
	function podPress_showID3tags($mediafile) {
		$fileinfo = podPress_getID3tags($mediafile);
...
//		header('Content-Disposition: attachment; filename="coverart.png"');
	...
	function podPress_downloadFile($uriFileName, $getHeaders = false)
	{
		GLOBAL $podPress;
