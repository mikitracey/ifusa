	<div id="sidebar">
      ...
      <?php /* If this is a yearly archive */ } elseif (is_year()) { ?>
		 ...
		 <?php /* If this is a monthly archive */ } elseif (is_search()) { ?>
			...
			<li><h2>:: RSS ::</h2> 
				<ul>
				<a href="feed:<?php bloginfo('rss2_url'); ?>">Entries</a><br />
		<a href="feed:<?php bloginfo('comments_rss2_url'); ?>">Comments</a>
				</ul>
			</li>

			<?php /* If this is the frontpage */ if ( is_home() || is_page() || is_category() || is_archive() ) { ?>				
				<?php get_links_list(); ?>
