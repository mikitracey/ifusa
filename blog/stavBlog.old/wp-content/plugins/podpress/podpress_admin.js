...
function podPressDetectLength(VarNum, params) {
	...
	podPressHttp_DetectLength.open("GET", podPressBackendURL+'podpress_backend.php?action=getfilesize&filename='+params, true);
...
function podPressDetectDuration(VarNum, params) {
	...
	podPressHttp_DetectDuration.open("GET", podPressBackendURL+'podpress_backend.php?action=getduration&filename='+params, true);
...
function podPressLoadFileInfo(VarNum) {
	...
	if(mp3filename != podPressLoadedMP3Info) {
		...
		podPressHttp_LoadFileInfo.open("GET", podPressBackendURL+'podpress_backend.php?action=showID3Contents&filename='+mp3filename+'&keynum='+VarNum, true);
